...
\section{Overview}
This report summarizes a self-contained ``particle universe'' model that encodes a compact closure for certainty-driven interactions, spin-induced torsion, two-sheet dynamics, and horizon drift. The model is not intended to be general relativity or Einstein--Cartan theory; instead it is a configurable sandbox for intuition building with explicit terms.
